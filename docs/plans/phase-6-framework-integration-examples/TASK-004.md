...
- 2026-05-11: Started Vue example implementation. Status set to active.
- 2026-05-11: Added `examples/vue/` with a Vite Vue app, shared Commonloom
  content generation, shared SCSS import, shared asset usage, and local
  dev/build/preview instructions. Status set to done.
