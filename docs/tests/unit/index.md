...
| [content-pipeline-links-media.test.ts](../../../test/content-pipeline-links-media.test.ts) | 9 | Link classification, link extraction, source positions, internal and wiki-link resolution, unsupported schemes, local media validation, traversal rejection, and alt text diagnostics. |
...
The current unit battery contains five Vitest files and twenty-seven tests.
